const TYPE_ICONS = {
  monitor: (
	...
	mouse: (
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-mouse2" viewBox="0 0 16 16">
  ...
  default: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-slate-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function AssetSelectionList({ items = [], onRemove }) {
  return (
    <div className="border border-slate-200 rounded-lg overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 bg-slate-100 border-b border-slate-200">
        <span className="text-sm font-bold text-slate-600">Current Selection</span>
        ...
        items.map((item, i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-slate-500 mt-0.5">SN: {item.serial}</p>
            </div>
            <button
